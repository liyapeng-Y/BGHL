...
from datasets.comm_utils import rearrange_node,keep_top_n_symmetric,compute_pe,get_comm_edge_index,get_community_graph,normalize
...
def read_comm_data(data_dir, filename, dist_matrix, coordinate, rearranged_indices, edge_num=30, pe_dim=30):
    ...
    rearrange_att = rearrange_node(att, rearranged_indices) 

    rearrange_dist_matrix = rearrange_node(dist_matrix, rearranged_indices)

    adj = np.abs(rearrange_att)  
    ...
    att_torch[att_torch == float('inf')] = 0  
    ...
    for start, end in zip(comm_index, comm_index[1:]):
        ...
        comm_nodes.append(att_torch[start:end, :])


    subgraph_edge_index, subgraph_edge_attr, subgraph_pe, subgraph_degree, subgraph_edge_index_0, subgraph_edge_index_1, subgraph_edge_index_2, subgraph_edge_index_3, subgraph_edge_index_4, subgraph_edge_index_5, subgraph_edge_index_6, subgraph_edge_index_7, subgraph_edge_attr_0, subgraph_edge_attr_1, subgraph_edge_attr_2, subgraph_edge_attr_3, subgraph_edge_attr_4, subgraph_edge_attr_5, subgraph_edge_attr_6, subgraph_edge_attr_7 = get_comm_edge_index(comm_index,
                                                                                                edge_index,
                                                                                                edge_att,
                                                                                                num_nodes,
                                                                                                pos_enc_dim=pe_dim)
    ...
    data = Data(x=att_torch, edge_index=edge_index.long(), y=y_torch, edge_attr=edge_att,
                ...
                comm_nodes_0 = comm_nodes[0], comm_nodes_1 = comm_nodes[1],
                comm_nodes_2 = comm_nodes[2], comm_nodes_3 = comm_nodes[3],
                comm_nodes_4 = comm_nodes[4], comm_nodes_5 = comm_nodes[5],
                comm_nodes_6 = comm_nodes[6], comm_nodes_7 = comm_nodes[7],
                subgraph_edge_index_0 = subgraph_edge_index_0,
                subgraph_edge_index_1 = subgraph_edge_index_1, subgraph_edge_index_2 = subgraph_edge_index_2,
                subgraph_edge_index_3 = subgraph_edge_index_3, subgraph_edge_index_4 = subgraph_edge_index_4,
                subgraph_edge_index_5 = subgraph_edge_index_5, subgraph_edge_index_6 = subgraph_edge_index_6,
                subgraph_edge_index_7 = subgraph_edge_index_7, subgraph_edge_attr_0 = subgraph_edge_attr_0,
                subgraph_edge_attr_1 = subgraph_edge_attr_1,
                subgraph_edge_attr_2 = subgraph_edge_attr_2, subgraph_edge_attr_3 = subgraph_edge_attr_3,
                subgraph_edge_attr_4 = subgraph_edge_attr_4, subgraph_edge_attr_5 = subgraph_edge_attr_5,
                subgraph_edge_attr_6 = subgraph_edge_attr_6, subgraph_edge_attr_7 = subgraph_edge_attr_7)
